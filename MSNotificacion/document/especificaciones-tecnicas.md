...
- **Eventos publicados:** `transfer.created`, `transfer.status.changed`, `mission.assigned` *(último pendiente de publicación — 2026-06-04)*
- **Implementación:** `MSLogistica/` — puerto **8085**, paquete `cl.catastrofescl.logistics`
- **APIs críticas:**
