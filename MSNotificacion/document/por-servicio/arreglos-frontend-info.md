...
### [FE-018] / [ARR-017] Menú lateral definitivo del dashboard
- **Fecha:** 2026-06-04
- **Autor:** Camilo / Claude
- **Tipo:** Feature | Refactor
- **Descripción:** Estructura de menú acordada (Gestión Usuarios, Emergencias, Centros, Logística, Inventario, Gestión Ciudadana). Eliminadas entradas obsoletas. Dos acordeones (`logistica`, `ciudadana`).
- **Archivos afectados:** `frontend-info/src/components/sidebar.tsx`
- **Tests actualizados:** N/A

### [FE-017] / [ARR-016] Unificación visual del sidebar
- **Fecha:** 2026-06-04
- **Autor:** Camilo / Claude
- **Tipo:** Bugfix | Refactor
- **Descripción:** Color consistente `#10170D` vía `sidebar--app` y `--dark-bg-sidebar` en `emergency.css`.
- **Archivos afectados:** `frontend-info/src/styles/emergency.css`, `sidebar.tsx`, `dashboard/layout.tsx`
- **Tests actualizados:** N/A

### [FE-016] / [ARR-015] Shell dashboard único + módulo logística
- **Fecha:** 2026-06-04
- **Autor:** Camilo / Claude
- **Tipo:** Feature | Refactor
- **Descripción:** Implementación módulo logística FE, sidebar único, `useGoogleMaps`, dibujo zonas sin DrawingManager.
- **Archivos afectados:** `frontend-info/src/app/dashboard/**`, `src/components/logistics/**`, `src/hooks/useLogistics.ts`, etc.
- **Tests actualizados:** N/A
